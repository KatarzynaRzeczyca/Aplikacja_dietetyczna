...
public class projekt2 extends JFrame implements ActionListener {
	...
	Date data;
	private Object danePacjentow[][];
	private long peseldb;
...
//	XYSeriesCollection ds = new XYSeriesCollection();
	...
	public void pokazBadanie(long Pesel) {
...
//		tdata = new JNumberTextField();
//		gbcbadanie.gridx = 2;
//		gbcbadanie.gridy = 0;
//		tdata.setPreferredSize(new Dimension(165, 20));
//		gbcbadanie.fill = GridBagConstraints.HORIZONTAL;
//    	badanie.add(tdata, gbcbadanie);
...
tTabela.getSelectionModel().addListSelectionListener(new ListSelectionListener() {
			...
			public void valueChanged(ListSelectionEvent arg0) {
				...
				if (tTabela.isRowSelected(wiersz) == true) {
...
//					JOptionPane.showMessageDialog(new JInternalFrame(), "Wpisz datê badania.");
//					return;
//				}
